...
VM_FLAG="-Dauth.config.path=conf/hbase/auth/ -Dzookeeper.sasl.clientconfig=client -Dzookeeper.server.principal=zookeeper/hadoop.hadoop_b.com -Dhadoop.user.root.path=/DOMAIN_B/WANGGUAN/XINGNENG/MANAGE"
...
set_classpath(){
	set ${LOADER_PATH}
        ...
        CLASSPATH=../.:../HBasePartitionDemo-1.0-SNAPSHOT.jar:${CLASSPATH}
}
